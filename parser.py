...
def MovieParser(text_File):
    ...
    with open(text_File,'rb') as csvfile:
        _csv_tmp=csv.reader(csvfile,delimiter=',')
        ...
        for _row_tmp in _csv_tmp:
            ...
            _movie_tmp=(_row_tmp[3],_row_tmp[11],_row_tmp[17],_row_tmp[23])#figure out the positions of the values we need, write them down
